...
export function ActiveItemsPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h2 className="text-3xl font-black text-white">Aktive Lernliste</h2>
        <p className="mt-2 text-slate-300">Aktuell {items.activeItems.length} von {settings.data.activePoolSize} Lerninhalten im täglichen Training.</p>
      </div>
      <LearningItemList
        items={items.activeItems}
        requiredCorrectAnswers={settings.data.requiredCorrectAnswers}
        emptyText="Keine aktiven Lerninhalte vorhanden."
