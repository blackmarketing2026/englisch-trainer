  ...
  return (
    <div className="space-y-5">
      ...
      <section className="rounded-xl border border-white/10 bg-white/5">
        <div className="hidden grid-cols-[minmax(12rem,2fr)_minmax(10rem,2fr)_6rem_6rem_8rem] gap-3 border-b border-white/10 bg-white/10 px-4 py-3 text-xs font-black uppercase text-slate-300 lg:grid">
          <span>Englisch</span>
          <span>Deutsch</span>
          <span>Status</span>
          ...
          {visibleItems.map((item) => {
            ...
            return (
              <article key={item.id} className="space-y-2 px-4 py-3">
                <div className="grid gap-2 lg:grid-cols-[minmax(12rem,2fr)_minmax(10rem,2fr)_6rem_6rem_8rem] lg:items-center lg:gap-3">
